  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.segment}>
          {STATUSES.map((s) => {
            ...
            return (
              ...
              >
                <Text style={active ? styles.segActiveText : styles.segText}>
                  {s.label}
                </Text>
              </Pressable>
            );
        ...
        <Text style={[text.overline, styles.label]}>NOTAS PARA O TREINADOR</Text>
        <TextInput
...
const styles = StyleSheet.create({
  ...
  segActive: { backgroundColor: color.orange500 },
  segText: { fontFamily: font.medium, fontSize: 12, color: color.textSecondary },
  segActiveText: { fontFamily: font.semibold, fontSize: 12, color: color.ink },
